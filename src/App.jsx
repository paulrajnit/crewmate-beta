...
const fm=FLT_RE.exec(line);const fno=fm[1];
...
//  Creates a “Jetstar✈️” calendar with emoji-rich event titles
// ═══════════════════════════════════════════════════════════════════
...
const calName=`Jetstar✈️`;
const ics=[
“BEGIN:VCALENDAR”,
“VERSION:2.0”,
“PRODID:-//CrewMate//Jetstar NZ Roster//EN”,
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
      ...
      <div style={{textAlign:"right",display:"flex",flexDirection:"column",gap:6,alignItems:"flex-end"}}>
        <div style={{display:"flex",gap:8}}>
          <button onClick={()=>downloadICS(roster,agenda,crew.crewName,crew.rosterMonth,crew.rosterYear)} style={{background:`${C.blue}22`,
