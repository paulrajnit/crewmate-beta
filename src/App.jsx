...
function PlaneBg(){
  return(
    <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,overflow:"hidden"}}>
      <style>{`
        @keyframes flyR{from{left:-8%}to{left:108%}}
        @keyframes flyL{from{left:108%}to{left:-8%}}
        @keyframes driftD{from{margin-top:0}to{margin-top:20vh}}
        @keyframes driftU{from{margin-top:0}to{margin-top:-20vh}}
      `}</style>
      {PLANE_DEFS.map(p=>{
