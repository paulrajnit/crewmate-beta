  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.75)",
      ...
      <div className="cm-sheet" style={{
        height:"88vh",padding:"2px 2px 0",
        borderRadius:"22px 22px 0 0",
        background:"linear-gradient(135deg,#0D4F6B 0%,#0A3D52 25%,#083A2E 50%,#0A4D3A 75%,#0D5C4A 100%)",
        boxShadow:"0 0 40px rgba(13,92,74,0.35),0 0 80px rgba(13,79,107,0.2)",
      }}>
      <div style={{height:"100%",background:C.card,borderRadius:"20px 20px 0 0",
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",
          padding:"6px 16px 10px",borderBottom:`1px solid ${C.border}`,flexShrink:0}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <div style={{width:28,height:28,borderRadius:8,background:"#1A3A5C",
              display:"flex",alignItems:"center",justifyContent:"center",fontSize:14}}>🛰</div>
            <div>
              <div style={{fontSize:11,fontWeight:700,color:C.text}}>{fno}</div>
              <div style={{fontSize:10,color:C.soft}}>FlightAware · {rego||icao}</div>
            </div>
          </div>
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            <button onClick={()=>window.open(faUrl,"_blank","noopener,noreferrer")}
              style={{background:`${C.blue}20`,border:`1px solid ${C.blue}40`,
                borderRadius:8,padding:"5px 10px",
                color:C.blue,fontSize:10,fontWeight:700,cursor:"pointer"}}>
              ↗ BROWSER
            </button>
        ...
        <div style={{flex:1,position:"relative",overflow:"hidden"}}>
          {loading&&(
            <div style={{position:"absolute",inset:0,display:"flex",
              ...
              gap:12,color:C.soft,fontSize:13}}>
              <div style={{fontSize:32}}>🛰</div>
              <div>Loading FlightAware…</div>
            </div>
          )}
          <iframe src={faUrl}
