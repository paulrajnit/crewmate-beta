...
const PLANE_DEFS = [
  {id:"p1", dur:42, delay:0,  color:"#FF6B35", op:0.14, dir:1,  yStart:8,  dy:18,  size:17},
  {id:"p2", dur:58, delay:16, color:"#00C8FF", op:0.11, dir:-1, yStart:25, dy:-14, size:20},
  {id:"p3", dur:46, delay:30, color:"#FF6B35", op:0.12, dir:1,  yStart:60, dy:-20, size:14},
  {id:"p4", dur:64, delay:8,  color:"#00C8FF", op:0.10, dir:-1, yStart:75, dy:16,  size:18},
  {id:"p5", dur:38, delay:24, color:"#FF6B35", op:0.11, dir:1,  yStart:88, dy:-12, size:15},
];
function PlaneBg(){
  return(
